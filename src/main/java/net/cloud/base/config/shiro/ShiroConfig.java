package net.cloud.base.config.shiro;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
        ...
        filterChainDefinitionMap.put("/admin/dev/register", "anon");
        filterChainDefinitionMap.put("/admin/dev/updateTime", "anon");

        filterChainDefinitionMap.put("/admin/login", "anon");

        List<net.cloud.base.entity.Resource> list = resourceService.findAll();
        for (net.cloud.base.entity.Resource resource : list) {
